...
<script>
    ...
    export default {
        name: 'c-library-drawer-doc-fulltext',
        ...
        methods: {
            ...
            async getLibraryFulltextList(page, handler) {
                ...
                let hres = {};
                await this.$api.v1.LibraryDocFulltextSearch({
                    ...page, library_id: this.libraryId, search_key: this.searchKey
            ...
            onConfirm(libraryDoc) {
                ...
                this.libraryContentEventBus.$emit('doc-will-modify', libraryDoc.id);
            }
        },
        components: {
